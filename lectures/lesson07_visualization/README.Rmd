...
ggplot(data = selfiesCasualties) +
  geom_bar(aes(class, fill = gender))
...
ggplot(data = freqCasualties) +
  geom_bar(aes(class, n, fill = gender), stat='identity')
...
ggplot(data = selfiesCasualties) +
  geom_bar(aes( class, y=..prop.., fill= gender, group = gender), position = 'dodge')
...
ggplot(dt) + geom_bar(aes(College, fill = Sex), position = 'fill')
...
ggplot(data =dt) +
 geom_bar(aes(x = College, fill = Sex)) +       #plot a count of students in each
  facet_wrap(~ Ethnicity, scales = 'free') #~ variable_name: is the variable that you wanna split for
...
# you can also split by another variable on the other axis
ggplot(data =dt) +
 geom_bar(aes(x = Ethnicity, fill = Sex)) +       #plot a count of students in each
  facet_grid(Sex ~ College, scales = 'fixed')
```
