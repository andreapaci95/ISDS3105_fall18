...
ggplot(tidy_sn_user) +
  geom_line(aes(year, Mil.Users, color = socialNet)) 
```
...
new_iphone<- gather(iphoneSales, 'model', 'quantity', iPhone4S:iPhoneX)
ggplot(new_iphone, aes(model, quantity)) + geom_bar(aes(fill=time), stat = 'identity') +
